...
@Composable
internal fun ColumnScope.EventsListToolbar(
        ...
        onClick = {
            postInput(
                DebuggerUiContract.Inputs.SendToDebuggerServer(
                    DebuggerServerContract.Inputs.ClearAllEvents(
...
@Composable
internal fun ColumnScope.EventsList(
    connection: BallastConnectionState?,
    viewModel: BallastViewModelState?,
    events: List<BallastEventState>,
...
@Composable
internal fun ColumnScope.EventDetailsToolbar(
    connection: BallastConnectionState?,
    viewModel: BallastViewModelState?,
...
@Composable
internal fun ColumnScope.EventDetails(
    event: BallastEventState?,
    postInput: (DebuggerUiContract.Inputs) -> Unit,
) {
    if (event != null) {
...
@Composable
internal fun rememberViewModelEventsList(
    viewModel: BallastViewModelState?,
    searchText: String,
