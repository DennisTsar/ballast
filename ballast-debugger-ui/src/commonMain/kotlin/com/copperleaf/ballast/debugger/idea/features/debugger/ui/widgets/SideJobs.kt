...
@Composable
internal fun ColumnScope.SideJobsListToolbar(
        ...
        onClick = {
            postInput(
                DebuggerUiContract.Inputs.SendToDebuggerServer(
                    DebuggerServerContract.Inputs.ClearAllSideJobs(
...
@Composable
internal fun ColumnScope.SideJobsList(
    connection: BallastConnectionState?,
    viewModel: BallastViewModelState?,
    sideJobs: List<BallastSideJobState>,
...
@Composable
internal fun ColumnScope.SideJobDetails(
    sideJob: BallastSideJobState?,
    postInput: (DebuggerUiContract.Inputs) -> Unit,
) {
    if (sideJob != null) {
...
@Composable
internal fun rememberViewModelSideJobsList(
    viewModel: BallastViewModelState?,
    searchText: String,
...
@Composable
internal fun Destination.ParametersProvider.rememberSelectedViewModelSideJob(
    viewModel: BallastViewModelState?,
