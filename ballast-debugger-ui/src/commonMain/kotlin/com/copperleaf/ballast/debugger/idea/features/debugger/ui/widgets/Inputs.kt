...
@Composable
internal fun ColumnScope.InputsListToolbar(
        ...
        onClick = {
            postInput(
                DebuggerUiContract.Inputs.SendToDebuggerServer(
                    DebuggerServerContract.Inputs.ClearAllInputs(
...
@Composable
internal fun ColumnScope.InputsList(
    connection: BallastConnectionState?,
    viewModel: BallastViewModelState?,
    inputs: List<BallastInputState>,
...
@Composable
internal fun ColumnScope.InputDetailsToolbar(
    connection: BallastConnectionState?,
    viewModel: BallastViewModelState?,
...
@Composable
internal fun ColumnScope.InputDetails(
    input: BallastInputState?,
    postInput: (DebuggerUiContract.Inputs) -> Unit,
) {
    if (input != null) {
...
@Composable
internal fun rememberViewModelInputsList(
    viewModel: BallastViewModelState?,
    searchText: String,
...
@Composable
internal fun Destination.ParametersProvider.rememberSelectedViewModelInput(
    viewModel: BallastViewModelState?,
